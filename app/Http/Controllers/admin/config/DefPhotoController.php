...
#|||||||||||||||||||||||||||||||||||||| #     index
    public function index(){
        ...
        return view('admin.config.photo_def.index',compact('pageData','rowData','defPhoto'));
    }
...
#|||||||||||||||||||||||||||||||||||||| #     create
    public function create(){
        ...
        return view('admin.config.photo_def.form',compact('pageData','rowData'));
    }
...
#|||||||||||||||||||||||||||||||||||||| #     edit
    public function edit($id){
        ...
        return view('admin.config.photo_def.form',compact('rowData','pageData'));
    }
...
#|||||||||||||||||||||||||||||||||||||| #     sortDefPhotoList
    public function sortDefPhotoList(){
        ...
        $pageData['ViewType'] = "List";
        return view('admin.config.photo_def.indexSort',compact('pageData','rowData'));
    }
#@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
#|||||||||||||||||||||||||||||||||||||| #     sortDefPhotoList
