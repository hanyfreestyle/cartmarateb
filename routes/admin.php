...
use App\Http\Controllers\WordPressProController;
use Illuminate\Support\Facades\Route;

Route::get('/wordD',[WordPressController::class,'index'])->name('admin.wors');
Route::get('/word',[WordPressProController::class,'index'])->name('admin.wors');
